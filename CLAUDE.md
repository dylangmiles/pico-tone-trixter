...
Reallocated 2026-05-01 to optimise proto-board wiring. All audio data lines (DOUT, DIN, SDA, SCL) now on Pico LEFT side; all clocks (BCLK, LRCLK, MCLK) on RIGHT side. See `../private/docs/proto_board_layout_2026-05-01.md` (repo `tone-trixter-private`) for routing rationale.
